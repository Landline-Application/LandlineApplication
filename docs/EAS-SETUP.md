# EAS Setup & Google Play Console Integration

Quick reference to official documentation for setting up EAS and connecting to Google Play Console.
...
- [Uploading to Google Play Store](https://docs.expo.dev/submit/android/)
