          ...
          <View style={styles.widgetMockup}>
            ...
            <View style={styles.widgetContent}>
              <TouchableOpacity
                style={[
                  styles.widgetButton,
                  {
                    backgroundColor: widgetState.isActive
                      ? LandlineColors.dark.success
                      : LandlineColors.dark.primary,
                  },
                ]}
            ...
            {widgetState.isActive && widgetState.notificationCount > 0 && (
              <Text style={styles.widgetNotificationCount}>
                {widgetState.notificationCount} notification
                {widgetState.notificationCount !== 1 ? 's' : ''}
              </Text>
            )}
          </View>
