...
const styles = StyleSheet.create({
  ...
  mainToggleActive: {
    backgroundColor: LandlineColors.dark.primary + '20',
  ...
  statusCardWarning: {
    borderColor: LandlineColors.dark.warning,
    backgroundColor: LandlineColors.dark.warning + '10',
  },
  statusCardHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  statusCardButton: {
    backgroundColor: LandlineColors.dark.warning,
    paddingVertical: 10,
