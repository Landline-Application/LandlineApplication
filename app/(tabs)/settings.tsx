        ...
        <View style={styles.section}>
          ...
          <Card variant="elevated" padding="none" style={styles.card}>
            ...
            <TouchableOpacity
              onPress={() => {
                haptics.light();
                router.push('/auto-reply' as Href);
              }}
              activeOpacity={0.7}
            >
              <View style={[styles.menuItem, { paddingHorizontal: Spacing.md }]}>
        ...
        <View style={styles.section}>
          ...
          <Card variant="elevated" padding="none" style={styles.card}>
            <TouchableOpacity
              onPress={() => {
                haptics.light();
                router.push('/core-permissions' as Href);
              }}
              activeOpacity={0.7}
            >
              <View style={[styles.menuItem, { paddingHorizontal: Spacing.md }]}>
        ...
        <View style={styles.section}>
          ...
          <Card variant="elevated" padding="none" style={styles.card}>
            <TouchableOpacity
              onPress={() => {
                haptics.light();
                router.push('/debug/landline' as Href);
              }}
              activeOpacity={0.7}
            >
              <View style={[styles.menuItem, { paddingHorizontal: Spacing.md }]}>
            ...
            <TouchableOpacity
              onPress={() => {
                haptics.light();
                router.push('/debug/tools' as Href);
              }}
              activeOpacity={0.7}
            >
              <View style={[styles.menuItem, { paddingHorizontal: Spacing.md }]}>
            ...
            <View style={styles.dataActions}>
              {Platform.OS === 'android' ? (
                ...
                <Button
                  ...
                  onPress={() => void handleExportMyData()}
                  variant="secondary"
                  size="md"
                  fullWidth
                  style={{ marginBottom: Spacing.md }}
