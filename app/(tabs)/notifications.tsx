          ...
          <>
            ...
            <View style={styles.categoriesGrid}>
              {categories.map((cat) => (
                ...
                >
                  ...
                  {cat.count > 0 && <Text style={styles.categorySubtext}>Tap to view</Text>}
                </TouchableOpacity>
              ))}
            </View>
            ...
            <View style={styles.recentSection}>
              ...
              {notifications.slice(0, 5).map((notif, index) => (
                <View key={`${notif.id}-${index}`} style={styles.notificationItem}>
                  <View style={styles.notificationHeader}>
                    ...
                    <Text style={styles.notificationTime}>{formatTime(notif.postTime)}</Text>
                  </View>
              ...
              {notifications.length > 5 && (
                <Text style={styles.moreText}>+ {notifications.length - 5} more notifications</Text>
              )}
            </View>
