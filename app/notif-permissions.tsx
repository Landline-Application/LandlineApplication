...
export default function SettingsScreen() {
  ...
  const handleNotificationSetting = (
    appId: string,
    setting: keyof AppPermission['notificationSettings'],
  ) => {
    setAppPermissions((prev) =>
      prev.map((app) =>
        app.id === appId
  ...
  const handleSave = () => {
    Alert.alert('Settings Saved', 'Your notification permissions have been updated.', [
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.descriptionSection}>
          <Text style={styles.descriptionText}>
            Customize which apps can send notifications during Landline mode and how they&apos;re
            handled.
          </Text>
        </View>
              ...
              <View style={styles.notificationSettings}>
                ...
                <View style={styles.settingRow}>
                  ...
                  <Switch
                    ...
                    thumbColor={
                      app.notificationSettings.sound ? '#fff' : LandlineColors.dark.textSecondary
                    }
                  />
                </View>
                <View style={styles.settingRow}>
                  ...
                  <Switch
                    ...
                    thumbColor={
                      app.notificationSettings.vibration
                        ? '#fff'
                        : LandlineColors.dark.textSecondary
                    }
                  />
                </View>
                <View style={styles.settingRow}>
                  ...
                  <Switch
                    ...
                    thumbColor={
                      app.notificationSettings.visual ? '#fff' : LandlineColors.dark.textSecondary
                    }
                  />
                </View>
              </View>
